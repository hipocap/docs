...
Tracing is also the entry point into Hipocap: it's how production runs become data in the platform. Once you're tracing, you can use [Platform](/platform) tools to explore traces, turn real failures into [Datasets](/datasets), and run comprehensive [Evaluations](/evaluations).
